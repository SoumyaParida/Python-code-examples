...
class Node:
    def __init__(self, info, left=None, right=None, level=None):  # constructor of class

        self.info = info  # information for node
        self.left = left  # left leef
        self.right = right  # right leef
        self.level = level  # level none defined
...
class searchtree:
    def __init__(self, root=None):  # constructor of class
